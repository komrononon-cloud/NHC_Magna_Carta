const voices = {
  ...
  silenced: {
    ...
    body:
      "Most peasants, women, labourers, and poorer townspeople did not sit at the table when Magna Carta was made. That silence matters. The document is famous, but it mostly spoke for the powerful. Its omissions remind us that democracy grows slowly, by widening who gets included.",
    insight:
...
const timeline = {
  1204: {
    ...
    body:
      "John lost Normandy to the French king, and that hurt his reputation badly. Later military campaigns became expensive, and money became one of the biggest reasons people started pushing back.",
  },
  1214: {
